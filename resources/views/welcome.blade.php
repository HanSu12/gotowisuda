...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ===== AWAL STYLE PANDUAN PENYIMPANAN (BARU) ===== */
        .storage-tip {
            margin-top: 25px;
            padding: 15px;
        ...
        /* ===== AKHIR STYLE PANDUAN PENYIMPANAN (BARU) ===== */
...
<script>
    ...
    function handlePrediction(file) {
        ...
        const apiUrl = '{{ $api_url ?? 'http://127.0.0.1:5000/predict' }}'; // Menggunakan URL API dari backend
        ...
        .then(data => {
            ...
            // ===== PERUBAHAN 1: Menambahkan Tips Penyimpanan ke labelMap =====
            const labelMap = {
                'kering': { color: '#e74c3c', emoji: '🌶️', label_display: 'Cabai Kering', description: 'Cabai dalam kondisi kering dan siap untuk disimpan', storage_tip: 'Simpan dalam wadah kedap udara di tempat yang sejuk dan gelap. Cabai kering bisa bertahan hingga satu tahun jika disimpan dengan benar.'},
                'sedang': { color: '#f39c12', emoji: '🌶️', label_display: 'Cabai Sedang', description: 'Cabai dalam kondisi setengah kering', storage_tip: 'Angin-anginkan di tempat terbuka hingga benar-benar kering sebelum disimpan, atau segera gunakan untuk bumbu masakan.'},
                'segar': { color: '#27ae60', emoji: '🫑', label_display: 'Cabai Segar', description: 'Cabai dalam kondisi segar dan baru dipetik', storage_tip: 'Simpan di dalam kulkas dengan membungkusnya dalam kertas atau plastik berlubang. Jangan mencuci cabai hingga saat akan digunakan.'}
            };
            const resultData = labelMap[prediction.toLowerCase()] || { color: '#7f8c8d', emoji: '❔', label_display: 'Tidak Diketahui', description: 'Hasil prediksi tidak dapat ditentukan', storage_tip: 'Tidak ada tips penyimpanan untuk hasil ini.'};
            ...
            // ===== PERUBAHAN 2: Menambahkan blok HTML untuk tips penyimpanan =====
            const resultHTML = `
                ...
                <div class="storage-tip">
                    <h4>💡 Panduan Penyimpanan</h4>
                    <p>${resultData.storage_tip}</p>
                </div>
